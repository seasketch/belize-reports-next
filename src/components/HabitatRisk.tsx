                ...
                {!props.printing && (
                  <Collapse title={t("Learn more")}>
                    <Trans i18nKey="habitatRisk Card - learn more">
                      <p>
                        ℹ️ Overview: The Habitat Risk Assessment (HRA) InVEST
                        tool has been used to evaluate the cumulative risk posed
                        to coastal and marine habitats by anthropogenic
                        stressors. Building upon the ecosystem-based assessment
                        presented in Belize's ICZM 2016 Plan and Interim ICZM
                        Plan 2020-2025, potential threats to coral reef,
                        seagrass, and mangrove ecosystems are analysed with data
                        updated to 2025 (current scenario). These ecosystems
                        serve as primary habitats for numerous ecologically and
                        economically important species while also providing a
                        range of benefits to people. The model incorporates nine
                        human activities and environmental stressors that may
                        affect the habitats of interest as outlined below: The
                        human stressors used for this assessment are (I)
                        Agriculture Runoff, (II) Aquaculture,(III) Coastal
                        Development, (IV) Dredging, (V) Fishing, (VI)
                        Recreation, (VII) Marine Transportation (VIII) Flooding
                        and (XI) Oil Exploration. The habitats used for this
                        assessment were mangroves, seagrass, and corals. The
                        following model shows the Habitat risk assessment for
                        Coral in Belize.
                      </p>
                      <p>
