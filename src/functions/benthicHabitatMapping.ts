...
/**
 * benthicHabitatMapping: A geoprocessing function that calculates overlap metrics for vector datasources
 * @param sketch - A sketch or collection of sketches
 * @param extraParams
 * @returns Calculated metrics and a null sketch
 */
export async function benthicHabitatMapping(
  sketch:
  ...
  const metricGroup = project.getMetricGroup("benthicHabitatMapping");
  const metrics = (
    await Promise.all(
...
export default new GeoprocessingHandler(benthicHabitatMapping, {
  title: "benthicHabitatMapping",
  description: "",
  timeout: 500, // seconds
